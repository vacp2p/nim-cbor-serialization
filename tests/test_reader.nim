...
createCborFlavor NullFields,
  skipNullFields = true

func toReader(input: string): CborReader[DefaultFlavor] =
  var stream = memoryInput(input)
  CborReader[DefaultFlavor].init(stream)

func toReaderNullFields(input: string): CborReader[NullFields] =
  var stream = memoryInput(input)
...
#}
const cbor1 = "0xA666737472696E676B68656C6C6F20776F726C64666E756D626572FBC05EDD2F1A9FBE7763696E7419031564626F6F6CF5646E756C6CF665617272617985F5FB4081BF1EB851EB856F737472696E6720696E206172726179F681187B"
...
#  "null"  : 0
#}
const cbor2 = "0xA566737472696E671819666E756D626572187B63696E7419031564626F6F6C16646E756C6C00"
...
#    }
#}
const cbor3 = ""
...
suite "CborReader basic test":
  test "readArray iterator":
    var r = toReader "0x83F4F5F4".fromHex
    var list: seq[bool]
  ...
  test "readObjectFields of null fields":
    ...
    var r = toReaderNullFields("0xA369736F6D657468696E67F664626F6F6CF566737472696E67F6".fromHex)
    check execReadObjectFields(r) == 1

    # {"something":null,"bool":true,"string":"moon"}
    var y = toReader("0xA369736F6D657468696E67F664626F6F6CF566737472696E67646D6F6F6E".fromHex)
    check execReadObjectFields(y) == 3

    # {"something":null,"bool":true,"string":"moon"}
    var z = toReaderNullFields("0xA369736F6D657468696E67F664626F6F6CF566737472696E67646D6F6F6E".fromHex)
  ...
  test "readObjectFields of null fields":
    ...
    var r = toReaderNullFields("0xA369736F6D657468696E67F664626F6F6C187B66737472696E67F6".fromHex)
    check execReadObject(r) == 1

    expect CborReaderError:
      # {"something":null,"bool":78,"string":345}
      var y = toReader("0xA369736F6D657468696E67F664626F6F6C184E66737472696E67190159".fromHex)
      check execReadObject(y) == 3

    # {"something":null,"bool":999,"string":100}
    var z = toReaderNullFields("0xA369736F6D657468696E67F664626F6F6C1903E766737472696E671864".fromHex)
  ...
  test "readValue of object without fields":
    ...
    block:
      var stream = memoryInput(cbor1.fromHex)
