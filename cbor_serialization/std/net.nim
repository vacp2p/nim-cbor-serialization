...
proc writeValue*(
    writer: var CborWriter, value: IpAddress) {.raises: [IOError].} =
...
proc writeValue*(
    writer: var CborWriter, value: Port) {.raises: [IOError].} =
...
proc writeValue*(
    writer: var CborWriter, value: AddressFamily) {.raises: [IOError].} =
  writeValue(writer, $value)
