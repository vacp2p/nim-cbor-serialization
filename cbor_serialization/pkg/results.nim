...
import
  pkg/results, ../../cbor_serialization/[reader, writer]
...
proc writeValue*[T](
    writer: var CborWriter, value: Result[T, void]) {.raises: [IOError].} =
  mixin writeValue
...
proc readValue*[T](reader: var CborReader, value: var Result[T, void]) {.
